...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid" style="text-align: center;" style="display: flex;">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Eliminar Venta N° <?=  $nro_venta; ?></h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <div class="col-md-3">
                    <div class="card card-outline card-danger">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <button id="btn-borrar_venta" class="btn btn-danger btn-block"> Borrar Venta</button>
                                <div id="btn_borrar"></div>
                            </div>
                            <script>
                                $('#btn-borrar_venta').click(function () {
                                    ...
                                    function actualizar_stock() {
                                        ...
                                        for (i = 1; i <= n ; i++){
                                            ...
                                            var stock_total_venta = parseFloat(parseInt(stock_inventario) + parseInt(cantidad_producto)); 
                                    ...
                                    function borrar_venta() {
                                        ...
                                        var url = "../../../App/controllers/ventas/eliminar_venta.php";
                                            $.get(url, {id_venta:id_venta, nro_venta:nro_venta}, function (datos) {
                                                $('#btn_borrar').html(datos);
                                            });
                                    }
                                });
                            </script>
