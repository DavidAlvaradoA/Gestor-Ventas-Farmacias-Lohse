                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="celular" class="form-control" value="<?= $celular?>" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Teléfono </label>
                                                        <input type="text" id="telefono" class="form-control" value="<?= $telefono?>" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="direccion" class="form-control" value="<?= $direccion?>" disabled>
                        ...
                        <div class="card-body" style="display: block;">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input style="text-align: center" type="text" value="<?php echo $nro_compra; ?>" class="form-control"
                                        disabled>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input style="text-align: center" type="text" class="form-control" id="comprobante" value="<?= $comprobante?>" disabled>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="">Precio compra:</label>
                                    <input style="text-align: center" type="number" class="form-control" id="ingreso_compra" value="<?= $precio_comprac?>" disabled>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="">Fecha de compra:</label>
                                    <input style="text-align: center" type="date" class="form-control" id="fecha_compra" value="<?= $fecha_compra?>" disabled>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="">Ingreso stock:</label>
                                    <input style="text-align: center" type="number" id="cantidad_compra" class="form-control" value="<?= $ingreso_stock?>" disabled>
                                </div>
                                <script>
                            ...
                            <div class="row" style="margin: 1px">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input style="text-align: center" type="text" value="<?php echo $nombres_sesion; ?>" class="form-control"
                                        disabled>
                                    </div>
                                </div>
                            </div>
