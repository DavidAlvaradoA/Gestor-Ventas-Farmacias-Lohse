                ...
                <div class="row">
                  ...
                  <form  action="../App/controllers/usuarios/update.php" method="post">
                    <input type="text" name="id_usuario" value="<?php echo $id_usuario_get;?>" hidden>
                      ...
                      <input type="text" name="nombres"class="form-control" value="<?php echo $nombres;?>" placeholder="Ingrese nombre..." required>
                      </div>
                      <div class="form-group">
                      <label for="">Email</label>
                      <input type="email" name="email"class="form-control" value="<?php echo $email;?>" placeholder="Ingrese email..." required>
                      </div>
                      <div class="form-group">
                      ...
                      <input type="password" name="password_user" class="form-control" placeholder="Ingrese Contraseña...">
                      </div>
                      <div class="form-group">
                      <label for="">Confirmar Contraseña</label>
                      <input type="password" name="password_repeat" class="form-control" placeholder="Confirme Contraseña...">
                      </div>
                      <hr>
                      <div class="form-group">
