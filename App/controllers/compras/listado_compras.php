...
$sql_compras = "SELECT *, com.precio_compra as ingreso_compra, INV.codigo_producto as codigo_producto, INV.nombre_producto as nombre_producto,  INV.stock_producto as stock_producto,
